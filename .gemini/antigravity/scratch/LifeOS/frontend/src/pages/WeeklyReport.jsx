    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-gray-400 mt-1">AI-powered performance analysis</p>
        </div>
        <button
          onClick={generateReport}
          disabled={generating}
          className="flex items-center gap-2 bg-indigo-600 hover:bg-indigo-700 disabled:opacity-50 text-white px-5 py-2.5 rounded-lg transition-colors text-sm font-medium"
        >
      ...
      {report ? (
        <div className="space-y-6">
          ...
          <div className="bg-gradient-to-br from-indigo-900/40 to-purple-900/20 rounded-2xl p-6 border border-indigo-800/30">
            ...
            <p className="text-gray-300 leading-relaxed">{report.report_data.performance_overview}</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-neutral-800 rounded-xl p-6 border border-neutral-700">
              ...
              <p className="text-gray-300 text-sm leading-relaxed">{report.report_data.key_strengths}</p>
            </div>
